...
t = new Equip;
t.name = '电磁搜索者头肩';
t.data.push({ type: '攻击强化', value: 3180 + (1078 - 404) * 2, times: 1 });
...
t = new Equip;
t.name = '沙漠星芒护肩';
t.data.push({ type: '攻击强化', value: 3180 + (1212 - 404) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 356, times: 1 });
t.tag = ['灼烧', '灼烧伤害 '];
...
t.data.push({ type: '攻击强化', value: 4446, times: 1 });
t.tag = ['灵魂', '恢复hp', '恢复mp'];
shoulders.set(t.name, t);
t = new Equip;
t.name = '玉化亡灵肩甲';
...
t = new Equip;
t.name = '冰玉之蚀肩甲';
t.data.push({ type: '攻击强化', value: 3180 + (1616 - 404) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 356, times: 1 });
t.tag = ['中毒', '中毒伤害'];
