...
t = new Equip;
t.name = '御雷腰带';
t.data.push({ type: '攻击强化', value: 4523 + (2021 - 1078) * 2, times: 1 });
...
t = new Equip;
t.name = '应尽之责腰带';
t.data.push({ type: '攻击强化', value: 2642 + (1212 - 135) * 2, times: 1 });
...
t = new Equip;
t.name = '信念之喘息腰带';
t.data.push({ type: '攻击强化', value: 4528 + (1751 - 1078) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 356, times: 1 });
...
t = new Equip;
t.name = '亘古的悬空石腰带';
t.data.push({ type: '攻击强化', value: 4164 + (1751 - 674) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 356, times: 1 });
