...
t = new Equip;
t.name = '轰天裂地石甲';
t.data.push({ type: '攻击强化', value: 3988 + (1482 - 808) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 926, times: 4 });
t.tag = ['队员人数'];
coats.set(t.name, t);
t = new Equip;
t.name = '高贵的神意上衣';
...
t = new Equip;
t.name = '双面星云皮大衣';
t.data.push({ type: '攻击强化', value: 4379 + (2290 - 1078) * 2, times: 1 });
t.tag = ['复活', '恢复mp'];
coats.set(t.name, t);
t = new Equip;
t.name = '玉化亡灵胸甲 ';
t.data.push({ type: '攻击强化', value: 4528 + (1886 - 1078) * 2, times: 1 });
t.tag = ['特效'];
coats.set(t.name, t);
t = new Equip;
t.name = '百折不挠的梦想';
t.data.push({ type: '攻击强化', value: 5066 + (2290 - 1347) * 2, times: 1 });
t.tag = ['睡眠', '复活', '恢复hp'];
coats.set(t.name, t);
t = new Equip;
t.name = '冤魂的执念上衣';
t.data.push({ type: '攻击强化', value: 4258 + (1886 - 943) * 2, times: 1 });
t.tag = ['变小', '回避率', '恢复mp', '恢复hp'];
coats.set(t.name, t);
t = new Equip;
t.name = '高科技战术指挥上衣';
t.data.push({ type: '攻击强化', value: 3988 + (1482 - 1078) * 2, times: 1 });
...
t = new Equip;
t.name = '屠龙者';
t.data.push({ type: '攻击强化', value: 5066 + (1751 - 1347) * 2, times: 1 });
...
t = new Equip;
t.name = '御力装甲上衣';
t.data.push({ type: '攻击强化', value: 4796 + (1616 - 1212) * 2, times: 1 });
...
t = new Equip;
t.name = '深渊之源上衣';
t.data.push({ type: '攻击强化', value: 5066 + (1616 - 1347) * 2, times: 1 });
t.tag = ['属性强化', '全属性附魔'];
t.other = ["对应属强-10", "全属性轮流附魔"];
coats.set(t.name, t);
t = new Equip;
t.name = '澎湃之心上衣';
t.data.push({ type: '攻击强化', value: 4379 + (1886 - 1078) * 2, times: 1 });
...
t = new Equip;
t.name = '极魂之驱上衣';
t.data.push({ type: '攻击强化', value: 3960 + (1347 - 943) * 2, times: 1 });
t.tag = ['变大', '霸体', '恢复mp', '恢复hp', '特效'];
coats.set(t.name, t);
t = new Equip;
t.name = '大地的馈赠上衣';
t.data.push({ type: '攻击强化', value: 5066 + (2021 - 1347) * 2, times: 1 });
...
t.name = '混乱核心胸甲';
t.data.push({ type: '攻击强化', value: 5336, times: 1 });
t.data.push({ type: '出血伤害', value: 5, times: 1 });
t.data.push({ type: '中毒伤害', value: 5, times: 1 });
t.data.push({ type: '感电伤害', value: 5, times: 1 });
t.data.push({ type: '灼烧伤害', value: 5, times: 1 });
t.tag = ['召唤'];
t.other = ['召唤'];
coats.set(t.name, t);
t = new Equip;
