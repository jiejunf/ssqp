...
t = new Equip;
t.name = '舞台的华丽';
t.data.push({ type: '攻击强化', value: 4258 + (1212 - 943) * 2, times: 1 });
...
t = new Equip;
t.name = '暴风骑士';
t.data.push({ type: '攻击强化', value: 3988 + (2021 - 943) * 2, times: 1 });
t.tag = ['恢复hp'];
t.other = ["恢复hp"];
pants.set(t.name, t);
t = new Equip;
...
t = new Equip;
t.name = '隐匿的自然生命';
t.data.push({ type: '攻击强化', value: 5066 + 2021 - 943, times: 1 });
...
t = new Equip;
t.name = '沧海之覆护腿';
t.data.push({ type: '攻击强化', value: 4796 + (2155 - 1212) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 356, times: 1 });
t.tag = ['中毒', '中毒伤害'];
...
t.data.push({ type: '攻击强化', value: 412, times: 9 });
t.data.push({ type: '攻击强化', value: 247, times: 9 });
t.tag = ['低血'];
pants.set(t.name, t);
t = new Equip;
t.name = '和平之翼长裤';
t.data.push({ type: '攻击强化', value: 4258 + (1482 - 943) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 1927, times: 1 });
t.tag = ['保护罩', '恢复mp'];
pants.set(t.name, t);
t = new Equip;
t.name = '苍龙闪影护腿';
t.data.push({ type: '攻击强化', value: 3720 + (1347 - 674) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 1186, times: 1 });
t.tag = ['属强'];
t.data.push({ type: '属强', value: 3, times: 5 });
pants.set(t.name, t);
t = new Equip;
t.name = '高科技战术护腿';
t.data.push({ type: '攻击强化', value: 2910 + (1616 - 269) * 2, times: 1 });
t.data.push({ type: '技能攻击力', value: 30, times: 0 });
t.tag = ['弹反', '精准格挡', '控制'];
pants.set(t.name, t);
t = new Equip;
t.name = '终极掌控者护腿';
