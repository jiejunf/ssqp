...
t = new Equip;
t.name = '流星飞电战靴';
t.data.push({ type: '攻击强化', value: 4702 + (2021 - 943) * 2, times: 1 });
...
t.data.push({ type: '技能攻击力', value: 2, times: 3 });
t.tag = ['异常状态'];
shoes.set(t.name, t);
t = new Equip;
t.name = '黑暗吞噬短靴';
...
t = new Equip;
t.name = '高科技战术强化靴';
t.data.push({ type: '攻击强化', value: 3894 + (1347 - 593) * 2, times: 1 });
...
t = new Equip;
t.name = '大地的践踏短靴';
t.data.push({ type: '攻击强化', value: 3988 + (2290 - 808) * 2, times: 1 });
t.tag = ['保护罩', '特效'];
shoes.set(t.name, t);
t = new Equip;
t.name = '摇曳的残影短靴';
t.data.push({ type: '攻击强化', value: 3988 + (1616 - 808) * 2, times: 1 });
t.data.push({ type: '属强', value: +20, times: 1 });
...
t = new Equip;
t.name = '流星追月短靴';
t.data.push({ type: '攻击强化', value: 3031 + (1347 - 404) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 371, times: 10 });
...
t = new Equip;
t.name = 'HEM加固靴';
t.data.push({ type: '攻击强化', value: 4796 + (2021 - 1212) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 356, times: 1 });
t.data.push({ type: '技能攻击力', value: 5, times: 1 });
t.tag = ['灼烧'];
