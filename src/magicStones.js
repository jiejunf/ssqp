...
t = new Equip;
t.name = '奔涌之息宝石';
t.data.push({ type: '攻击强化', value: 3354 + (539 - 269) * 2, times: 1 });
t.tag = ['CD'];
...
t = new Equip;
t.name = '子夜的圣域';
t.data.push({ type: '攻击强化', value: 4528 + (1347 - 1078) * 2, times: 1 });
t.tag = ['CD'];
magicStone.set(t.name, t);
t = new Equip;
t.name = '未知的黄金石碑';
t.data.push({ type: '攻击强化', value: 3720 + (1078 - 674) * 2, times: 1 });
t.data.push({ type: '技能攻击力', value: 2, times: 4 });
t.tag = ['特效'];
t.other = ["异抗+16%"];
magicStone.set(t.name, t);
t = new Equip;
...
t.data.push({ type: '攻击强化', value: 1482, times: 1 });
t.tag = ['所有速度', '出血'];
t.other = ["恢复hp", "加速"];
magicStone.set(t.name, t);
t = new Equip;
...
t = new Equip;
t.name = '诅咒之心';
t.data.push({ type: '攻击强化', value: 3180 + (1347 - 404) * 2, times: 1 });
...
t = new Equip;
t.name = '陆战型:战术车轮无人机';
t.data.push({ type: '攻击强化', value: 5066 + (1616 - 1078) * 2, times: 1 });
