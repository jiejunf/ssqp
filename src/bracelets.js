...
t = new Equip;
t.name = '收获之手';
t.data.push({ type: '攻击强化', value: 3180 + (674 - 404) * 2, times: 1 });
t.data.push({ type: '技能攻击力', value: 6, times: 1 });
t.data.push({ type: '冷却恢复速度', value: 5, times: 5 });
t.tag = ['耐久度', 'CD'];
bracelets.set(t.name, t);
t = new Equip;
t.name = '电离掌控手镯';
t.data.push({ type: '攻击强化', value: 4528, times: 1 });
t.data.push({ type: '技能攻击力', value: 2964, times: 1 });
t.tag = ['瞬移', '恢复hp'];
bracelets.set(t.name, t);
t = new Equip;
t.name = '迟钝的感知手镯';
t.data.push({ type: '攻击强化', value: 3450 + (1347 - 539) * 2, times: 1 });
t.tag = ['灼烧伤害 ', '自身灼烧'];
...
t = new Equip;
t.name = '石巨人之核手镯';
t.data.push({ type: '攻击强化', value: 3165 + (1482 - 1212) * 2, times: 1 });
...
t.data.push({ type: '技能攻击力', value: 4, times: 3 });
t.tag = ['减伤', '异常赋予'];
bracelets.set(t.name, t);
t = new Equip;
t.name = '黑灵缠绕手镯';
...
t = new Equip;
t.name = '自由之缚手镯';
t.data.push({ type: '攻击强化', value: 4608 + (1078 - 674) * 2, times: 1 });
...
t = new Equip;
t.name = '魔力抑制手镯';
t.data.push({ type: '攻击强化', value: 3988 + (1347 - 808) * 2, times: 1 });
...
t.name = '和谐之音手镯';
t.data.push({ type: '攻击强化', value: 4528, times: 1 });
t.data.push({ type: '技能攻击力', value: 1, times: 10 });
t.tag = ['hp最大值'];
bracelets.set(t.name, t);
t = new Equip;
t.name = '生命之力皮护腕';
...
t = new Equip;
t.name = '无人机战术手镯';
t.data.push({ type: '攻击强化', value: 4393 + (1347 - 674) * 2, times: 1 });
t.data.push({ type: '攻击强化', value: 385, times: 10 });
t.tag = ['CD', '攻击强化'];
t.data.push({ type: '冷却时间', value: -12, times: 1 });
bracelets.set(t.name, t);
t = new Equip;
t.name = '电弧爆源手镯';
t.data.push({ type: '攻击强化', value: 3638 + (1347 - 1078) * 2, times: 0 });
t.data.push({ type: '技能攻击力', value: 15, times: 0 });
t.data.push({ type: '技能攻击力', value: 5, times: 0 });
t.tag = ['石化', '石化技攻'];
bracelets.set(t.name, t);
